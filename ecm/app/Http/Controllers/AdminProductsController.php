...
class AdminProductsController extends Controller
{
    ...
    public function updateFunction(Request $request)
    {
        $request->validate([
            ...
            'sell_price' => 'string|max:255',

            'stock_quentity' => 'string|max:255',

            'category_id' => 'string|max:255',

            'original_price' => 'string|max:255',

            'discount_price' => 'string|max:255',
        ...
        if ($request->has('id')) {
            ...
            $data['updated_at'] = now();
            DB::table('product')->where('id', (int)$request->id)->update($data);
        } else {
            // Create new category
