    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('admin/users') ? 'active' : '') }}" href="{{ url('admin/users') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('admin/users') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('admin/category') ? 'active' : '') }}" href="{{ url('admin/category') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('admin/category') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('admin/products') ? 'active' : '') }}" href="{{ url('admin/products') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('admin/products') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('admin/product_reviews') ? 'active' : '') }}" href="{{ url('admin/product_reviews') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('admin/product_reviews') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Đánh giá sản phẩm</span>
        </a>
      </li>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('admin/orders') ? 'active' : '') }}" href="{{ url('admin/orders') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('admin/orders') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
